...
= 2.3.7 =
- Fix: Typo in catalog settings attribute causing PHP: Notice
...
- New: Add naked display mode to use theme CSS for diplaying product forms and buttons
- Update: Include product load scripts on all post types by default

= 2.0.16 = 

- Fix: Fatal error in PHP 7.1 caused by array access to empty strings

= 2.0.15 =

- Fix: Invalid taxonomy error when managing product categories

= 2.0.14 =

- New: Choose between the Cart66 product layout or a custom layout when using the Cart66 Product post type
- Fix: Undefined property notice when viewing system information in the Cart66 admin
- Fix: Improve product search results for products with spaces in their names

= 2.0.13 = 

- New: The WordPress site url is set automatically in your Cart66 Cloud dashboard when you save your Cart66 settings in WordPress
- Update: Add wp_title filter fall back for better detection of page title replacements on slurped pages
...
- Fix: Resolve Select2 JavaScript library conflicts by downgrading to version 3.5.4
- Fix: Create page slurp page notification was taking two clicks to dismiss, now it just takes one.
- Fix: Title not shown in title tag on receipt page
- Fix: Improvements pressing products into WordPress from Cart66 Cloud dashboard
- Update: Improved page slurp detection resolving the problem where receipts were not shown properly in some themes
- Update: Update JavaScript library for Cart66 Cloud image gallery to improve WordPress 4.5 compatibility
...
- Fix: Resolve naming colissions from the inclusion of the dom parser library
